...
```
There are `r dim(zori_zip)[1]` observations with different date and rent index.
...
```
The zip codes are not included in ZORI data with some possible situations that
